...
export default function Header() {
  return (
    <section className="flex flex-col gap-4 m-5 flex-1 md:mx-10">
      <Navbar />
      <section
      ...
      >
        <h3 className="w-fit flex gap-3 text-[#DFFF00] text-xs uppercase tracking-widest border border-[#DFFF00]/30 bg-yellow-200/10 rounded-full py-1 px-4 md:py-2">
          <Zap size={16} strokeWidth={1} />A revolução do fitness digital
        </h3>
        ...
        <section className="w-full flex flex-col justify-between items-center md:flex-row">
          <section className="flex flex-col gap-6 md:flex">
            ...
            <Button
              className="w-full bg-[#DFFF00] text-neutral-900 font-normal py-6 px-2 rounded-2xl border-none hover:bg-[#DFFF00]/80 md:w-48"
            >
              Criar Conta Grátis
              <ArrowRight />
            </Button>
